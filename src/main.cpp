...
uint256 hashGenesisBlock("0x2ecf8ab54303eb0ab750fda02b38a22c252f27acee1ce1c75a24a78096dc5645");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Homocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Homocoin Signed Message:\n";
...
{
    // Homocoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Homocoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Homocoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Homocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2ecf8ab54303eb0ab750fda02b38a22c252f27acee1ce1c75a24a78096dc5645");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1394368658;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085033812;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HomocoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HomocoinMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running Homocoin with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("HomocoinMiner terminated\n");
        throw;
    }
}
